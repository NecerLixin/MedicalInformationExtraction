...
def eval(model: NerModelBert, dev_dataset, batch_size):
    dev_loader = DataLoader(
        dev_dataset, batch_size=batch_size, collate_fn=collate_fn_bert
    )
    model.eval()
    preds = []
    labels = []
...
def train(
    ...
    train_loader = DataLoader(
        train_dataset, batch_size=args.batch_size, collate_fn=collate_fn_bert
    )
...
def main():
    ...
    parser.add_argument("--info", type=str, default="NER bert+CRF model")
